...
- LLM:    HuggingFace InferenceClient (무료 티어)
- 벡터DB: FAISS (인메모리)
"""
...
SYSTEM_MESSAGE = """You are a helpful assistant for the Korean educational reading platform '독서로' (read365.edunet.net).
...
def answer(question: str, chain: dict) -> dict:
    ...
    messages = [
        ...
        {"role": "user", "content": f"[FAQ Documents]\n{context}\n\n[Question]\n{question}"},
    ]
